...
MAIN_CLASS="com.beyondmap.bpush.publisher.ServerMain";
#DEFAULT_OPTS="-server -Xms8G -Xmx8G -Xmn1G -XX:PermSize=50M -XX:MaxPermSize=50M -Xss256k -Dio.netty.leakDetectionLevel=advanced" ;
DEFAULT_OPTS="-server -Xms1G -Xmx1G -Xmn512m -XX:PermSize=50M -XX:MaxPermSize=50M -Xss256k -Dio.netty.leakDetectionLevel=advanced" ;
